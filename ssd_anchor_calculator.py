...
# ssd_anchor = ssd_anchor_calculator()
# anchors = ssd_anchor.generate_ssd_anchor()
# print(len(anchors))
...
#                 aspect_ratios_list.append(aspect_ratios[i])
#                 scales.append(scale)
...
#     feature_map_height = ceil(1.0 * input_size_height / stride)
#     feature_map_width = ceil(1.0 * input_size_width / stride)
